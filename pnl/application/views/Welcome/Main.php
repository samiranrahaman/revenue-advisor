	   ...
	   <div class="xs col-md-12">
           <h3>Welcome to Dashboard, Alix !</h3>
				...
				<div class="hr-divider m-t m-b-md">
						<h3 class="hr-divider-content hr-divider-heading">WATCH THIS VIDEO TO GET STARTED</h3>
				  </div>
            
            
            <div class="embed-responsive embed-responsive-16by9">
			  <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/v9QXDSk6jFo"></iframe>
			</div>
