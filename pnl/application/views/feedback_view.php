...
<div class="form-w3ls">
    ...
    <p>Please help us to serve you better by taking a couple of minutes. </p>
              ...
              <div class="form-group"  ng-class="{ 'has-error' : regform.subject.$invalid && !regform.subject.$pristine }">
			   <p>Select Subject:</p>
				 <select class="form-control1"  id="subject" name="subject"  required ng-model="subject"
					ng-options="opt for opt in feedbacksubject">
				</select>
				
				<p ng-show="regform.subject.$invalid && !regform.subject.$pristine" class="help-block">Subject is required.</p>
				</div>
		  
       <div class="form-group"  ng-class="{ 'has-error' : regform.user_feedback.$invalid && !regform.user_feedback.$pristine }">
         <p>Feedback:</p>
		 <textarea id="user_feedback" name="user_feedback" ng-model="user_feedback" required  style="height:150px; width: 100%;"></textarea>
      ...
      <div class="form-group"  ng-class="{ 'has-error' : regform.user_first_name.$invalid && !regform.user_first_name.$pristine }">
         <p>Your Name:</p>
		 <input type="text" class="form-control" placeholder="Name" id="user_first_name" name="user_first_name" ng-model="user.user_first_name" required >
