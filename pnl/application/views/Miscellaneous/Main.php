     ...
     <div class="form-group has-feedback" ng-class="{ 'has-error' : miscellaneous.datetime.$invalid && !miscellaneous.datetime.$pristine }">
      ...
      <div class="form-group">
        <div class="col-xs-4 pull-right">
		        <button type="submit" class="btn-dange flt_right" ng-disabled="miscellaneous.$invalid">Set Miscellaneous</button>
       </div>
	  </div>
	   </fieldset>
    </form>	
	  ...
	  <hr/>
       ...
       <thead>
          <tr class="tblma">
            <th class="orng">Miscellaneous Name</th>
            <th class="orng">Miscellaneous Date</th>
            <th class="orng">Miscellaneous cost</th>
            <th class="orng">Action</th>
                ...
                if(data>0)
 				 {
					  //$scope.validationESuccess = true;
					   window.location.href="http://sjcreativedesigns.com/pnl/index.php/miscellaneous/";
				 }
				 /* else
				 {
