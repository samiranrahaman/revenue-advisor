<script src="<?php echo base_url();?>css/angular-ui-bootstrap-modal.js"></script>
  ...
  <div ng-init='init()'class="content-wrapper" ng-controller="supplier">
	...
	<div class="row row-centered">		
        ...
        <div class="col-xs-6 col-centered col-min">			
		<a href="http://sjcreativedesigns.com/pnl/index.php/Dashboard">Return Home<a>
		</div>
                 ...
                 if(data==1)
 				 {
					  //$scope.validationESuccess = true;
					   window.location.href="http://sjcreativedesigns.com/pnl/index.php/newproductadd/complete";
				 }
				 else
				 {
