...
<!-- css files -->
<link href="http://sjcreativedesigns.com/pnl/css/style_l.css" rel='stylesheet' type='text/css' media="all" />
<!-- /css files -->
...
<div class="form-w3ls">
    ...
    <ul class="tab-group cl-effect-4">
         ...
         <li class="tab "><a href="http://sjcreativedesigns.com/pnl/">Home</a></li>
		<li class="tab "><a href="http://sjcreativedesigns.com/pnl/index.php/login">Sign In</a></li>
		<li class="tab active"><a href="http://sjcreativedesigns.com/pnl/index.php/registration">Join Us</a></li>        
    </ul>
	  ...
	  // check to make sure the form is completely valid
        ...
        //headers: {'Content-Type': 'application/json'},
			...
			data :JSON.stringify({user_first_name:$scope.user.user_first_name, user_last_name:$scope.user.user_last_name,
                 ...
                 if(data>0)
				 {
					  window.location.href="http://sjcreativedesigns.com/pnl/index.php/Login";
				 }
				 else
				 {
