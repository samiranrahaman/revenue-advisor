  ...
  <div class="login-box-body">
   ...
   <form  id="loginForm" name="loginForm" ng-submit="loginformsubmit()" novalidate >
	  ...
	  <div class="col-xs-4 pull-right">
		        <a href="http://sjcreativedesigns.com/pnl/index.php/registration" class="btn btn-primary">Registration</a>
      </div>
    </form>
  ...
  $scope.loginformsubmit = function () {
	  // check to make sure the form is completely valid
			if ($scope.loginForm.$valid) {
				...
				/*  $http.get('<?php //echo site_url('Login/verify_login')?>http://sjcreativedesigns.com/pnl/login/verify_login',{username: $scope.user.username,passwrd: $scope.user.passwrd})
        ...
        //headers: {'Content-Type': 'application/json'},
			...
			data :JSON.stringify({username:$scope.user.username, passwrd:$scope.user.passwrd})
                 ...
                 if(data.status==1)
				 {
					  window.location.href="http://sjcreativedesigns.com/pnl/index.php/Dashboard";
				 }
				 else
				 {
...
$redirect_uri = "http://sjcreativedesigns.com/pnl/index.php/Dashboard";
