            ...
            <div class="panel panel-warning bodr">
				...
				<tbody>
					...
					<tr ng-repeat="prodctitem in setupproducts ">
					  ...
					  <td class="col-sm-4 ">		
						<a ng-if="prodctitem.total_price!=0" class="btn btn-dange" style="" href="<?php echo base_url();?>index.php/reports/viewreport/{{prodctitem.id}}">View</a>
						<a ng-if="prodctitem.total_price==0" class="btn btn-dange" style="" href="#">View</a>
						  <a class="btn btn-dange" style="" href="<?php echo base_url();?>index.php/newproductadd/othercostedit/{{prodctitem.id}}">Edit</a>
						 <button class=" btn btn-danger" ng-click="delete(prodctitem.id)">Delete</button>
						...
						if(data==1)
						 {
							  //$scope.validationESuccess = true;
							   window.location.href="http://sjcreativedesigns.com/pnl/index.php/reports";
						 }
						 else
						 {
