    ...
    <section class="container">
	   <div id="page-wrapper">
		...
		<table class="table table-striped">
           ...
           <tr class="tblma"> 
			  <th  class="orng" colspan="2">Cost</th>
			</tr>
			<tr class="tblma">
				<th class="orng">Descriptions</th>
				<th class="orng">Values</th>
			</tr>
			...
			<thead>
			    <tr class="tblma">
				 <th class="orng"colspan="2">Revenues</th>
			    </tr>
			  <tr class="tblma">
				<th class="orng">Descriptions</th>
				<th class="orng">Values</th>
		...
		<!-- chalanges revenue end-->
		 ...
		 <div class="row" style="width:100%"  ng-show="recordfound2" >
			...
			<thead>
			    <tr class="tblma">
				 <th class="orng" colspan="2">Automated</th>
			    </tr>
			    <tr class="tblma">
				<th class="orng">Descriptions</th>
				<th class="orng">Values</th>
			...
			<thead>
			    <tr class="tblma">
				 <th class="orng" colspan="2" >Results</th>
			    </tr>
			    <tr class="tblma">
				<th class="orng">Descriptions</th>
				<th class="orng">Values</th>
			...
			<thead>
			    <tr class="tblma">
				 <th colspan="2" class="orng">Automated</th>
			    </tr>
			   <tr class="tblma">
				<th class="orng">Descriptions</th>
				<th class="orng">Values</th>
			...
			<thead>
			    <tr class="tblma">
				 <th colspan="2" class="orng"  >Results</th>
			    </tr>
			    <tr class="tblma">
				<th class="orng">Descriptions</th>
				<th class="orng">Values</th>
