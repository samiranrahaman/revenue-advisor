								 ...
								 <div class="clearfix"> </div>   
								   ...
								   <div class="panel panel-warning bodr">
										<div class="panel-heading">
											<h2>CONNECT ACCOUNT WITH REVENUE ADVIZER</h2>
									...
									<div class="clearfix"> </div>   
										 ...
										 <div class="panel panel-warning bodr">
											<div class="panel-heading">
												<h2>CURRENTLY INTEGRATED ACCOUNT WITH REVENUE ADVISER</h2>
									...
									<div class="well1 white"> 
											   ...
											   <!--<div class="col-sm-2">{{x.store_apikey}}</div>
											    <div class="col-sm-2">{{x.store_app_password}}</div>-->
												 ...
												 <div class="row topmar">
														...
														<div class="col-sm-12">
														<button class="sfbtn" ng-click="delete_store(x.id)">Delete</button>
														<button class="sfbtn" ng-click="setupdata(x.store_name,x.store_apikey,x.store_app_password,x.id);">Setup my Revenue Reports</button>
														</div>
									 ...
									 <div class="clearfix"> </div>   
										  ...
										  <div class="panel panel-warning bodr">
											<div class="panel-heading">
												<h2>CURRENTLY INTEGRATED FACEBOOK ACCOUNT WITH REVENUE ADVISER</h2>
										  ...
										  <div class="clearfix"> </div>   
                                           <div class="well1 white"> 
														...
														<div class="row topmar  fbcolr ng-scope" ng-repeat="fb in fb_accounts " >
															 <div class="col-sm-1 fbcolr"><i class="fa fa-facebook-square fa-2x"></i></div>
															<!-- <div class="col-sm-2">{{fb.app_id}}</div>
															 <div class="col-sm-2">{{fb.app_secret}}</div>-->
															 <div class="col-sm-3">{{fb.ads_act}}</div>
															  <div class="col-sm-3">{{fb.created_at}}</div>
															 <div class="col-sm-5">
															 <button class="fbbtn" ng-click="delete_fb(fb.id)">Delete</button>
															 <button class="fbbtn" ng-click="fb_setupdata(fb.ads_act,fb.id);">Setup my Revenue Reports</button>
        ...
        url : '<?php echo base_url();?>index.php/intregation/store_fulfillment',
                ...
                data :JSON.stringify({account_name:$scope.store.account_name, apikey:$scope.store.apikey,password:$scope.store.password,url:$scope.store.url})
				 ...
				 console.log(data.status);
				    if(data.status==1)
				 {
					  window.location.href="http://sjcreativedesigns.com/pnl/index.php/Intregation";
				 }
				 else
				 {
